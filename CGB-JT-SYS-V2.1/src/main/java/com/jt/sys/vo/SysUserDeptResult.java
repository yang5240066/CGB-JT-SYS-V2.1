...
public class SysUserDeptResult implements Serializable{
	...
	private SysDept sysDept;//关联部门Pojo对象
	...
	public String toString() {
		return "SysUserDeptResult [sysDept=" + sysDept + ", id=" + id + ", username=" + username + ", password="
				+ password + ", salt=" + salt + ", email=" + email + ", mobile=" + mobile + ", valid=" + valid
