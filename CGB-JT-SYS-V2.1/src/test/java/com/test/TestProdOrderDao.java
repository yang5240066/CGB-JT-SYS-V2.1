...
public class TestProdOrderDao extends TestBase{
	...
	public void testFindPageObjects(){
		...
		List<ProdMenu> list = dao.findPageObjects("p");//param1,param2,param3								
	...
	public void testDeleteObjects(){
		ProdOrderDao dao = ctx.getBean(ProdOrderDao.class);
		int rowCount = dao.deleteObject(2,4);
